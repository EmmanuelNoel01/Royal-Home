...
SECRET_KEY = 'q-_h&vl0z2!kd*4@3*7%jl0g6pr(w4l!1kpe1nvg@r3#^r&5k4'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join('users/static/users')
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_URL = '/media/'

CRISPY_TEMPLATE_PACK = 'bootstrap4'

LOGIN_REDIRECT_URL = 'hostels'
LOGIN_URL = 'login'
